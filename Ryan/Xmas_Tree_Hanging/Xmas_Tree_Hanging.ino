...
int button1 = A4;   //white tree
int button2 = A2;    //yellow tree
int button3 = A3;     //green tree
...
void song()
{
  int duration = 350; // controls tempo of song
  songA(duration);
  songB(duration);
  songA(duration);
  songC(duration);
